...
@app.route('/summarystats.com/datatypeassignment', methods=['POST','GET'])
def my_form_post():
    ...
    with open(csv_file) as file:        
        ...
        count_of_fields = len(header)
        return render_template('GetDataType.html', fields=header, datatypes=datatypes, length=count_of_fields)
...
def my_form_types():
    ...
    return render_template('SummaryDisplay.html', summary=summary, fields=header)
